...
fn lexiparser_source(indent: usize, verbose: bool) -> Result<(BufLog, String), BufLog> {
    ...
    let ll1_tables = ProdRuleSetTables::new(
        ...
        vec![
            ...
            prod!(%(12, 1), nt 13, nt 27),
            prod!(%(15, 1), nt 16, nt 28),
            prod!(%(5, 11), t 0, nt 8, t 14; %(5, 16), t 14),
            prod!(t 9, nt 29; %(13, 16), t 11; t 15, nt 30; %(13, 18), e),
            prod!(%(14, 4), t 4, t 27; %(14, 6), e),
            prod!(%(16, 3), t 8, t 32; %(16, 4), e),
            prod!(%(12, 1), nt 21; %(12, 1), e),
            prod!(%(15, 1), nt 22; %(15, 1), e),
            prod!(%(13, 10), t 11; %(13, 13), e),
            prod!(%(13, 3), t 11; %(13, 6), e),
        ],
        origin,
