...
fn gramparser_source(indent: usize, verbose: bool) -> Result<(BufLog, String, String, String), BufLog> {
    ...
    static ORIGIN: [(Option<usize>, &[(GrNode, &[usize])]); 9] = [
        ...
        (Some(3), &[(gnode!(t 9), &[]), (gnode!(t 15), &[]), (gnode!(t 6), &[]), (gnode!(&), &[0,1,2])]),
        ...
        (Some(10), &[(gnode!(t 15), &[]), (gnode!(t 11), &[]), (gnode!(t 12), &[]), (gnode!(t 13), &[]), (gnode!(t 14), &[]), (gnode!(t 1), &[]), (gnode!(nt 5), &[]), (gnode!(t 5), &[]), (gnode!(&), &[5,6,7]), (gnode!(t 7), &[]), (gnode!(|), &[0,1,2,3,4,8,9])]),
    ];
    ...
    let ll1_tables = ProdRuleSetTables::new(
        ...
        vec![
            ...
            prule!(%(6, 2), nt 9),
            prule!(nt 8, nt 13),
            prule!(%(8, 0), t 15; %(8, 1), t 11; %(8, 2), t 12; %(8, 3), t 13; %(8, 4), t 14; %(8, 8), t 1, nt 5, t 5; %(8, 9), t 7),
        ...
        origin,
        vec![("Colon", Some(":")), ("Lparen", Some("(")), ("Or", Some("|")), ("Plus", Some("+")), ("Question", Some("?")), ("Rparen", Some(")")), ("Semicolon", Some(";")), ("Sep", Some("/")), ("Star", Some("*")), ("Grammar", Some("grammar")), ("SymEof", Some("EOF")), ("Lform", None), ("Rform", Some("<R>")), ("Pform", Some("<P>")), ("Greedy", Some("<G>")), ("Id", None)],
