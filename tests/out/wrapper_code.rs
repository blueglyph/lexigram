...
pub(crate) mod code_15_1 {
    /// User-defined type for `b`
    #[derive(Debug, PartialEq)]
    pub struct SynB();

    /// User-defined type for `d`
    #[derive(Debug, PartialEq)]
    pub struct SynD();
}
