...
pub(crate) mod lexiparser {
    ...
    static SYMBOLS_T: [(&str, Option<&str>); 34] = [
        ...
        ("Pop", Some("pop")),("Push", Some("push")),("More", Some("more")),("Skip", Some("skip")),("Type", Some("type")),("Channel", Some("channel")),("SymEof", Some("EOF")),("Id", None),("CharLit", None),("StrLit", None),
    ...
    impl EnumSynValue {
        ...
        fn nt(&self) -> VarId {
            match &self {
                ...
                EnumSynValue::Actions(_) => 6,
                EnumSynValue::Action(_) => 7,
                EnumSynValue::Match(_) => 8,
                EnumSynValue::AltItems(_) => 9,
                EnumSynValue::AltItem(_) => 10,
                EnumSynValue::RepeatItem(_) => 11,
                EnumSynValue::Item(_) => 12,
                EnumSynValue::CharSet(_) => 13,
                EnumSynValue::CharSetOne(_) => 14,
                EnumSynValue::File1(_) => 15,
                EnumSynValue::Option1(_) => 16,
                EnumSynValue::Actions1(_) => 17,
                EnumSynValue::AltItems1(_) => 18,
                EnumSynValue::AltItem1(_) => 19,
                EnumSynValue::CharSet1(_) => 20,
            }
        }
    }
    ...
    impl<T: LexiParserListener> Wrapper<T> {
        ...
        fn init_option1(&mut self) {
            ...
            self.stack.push(EnumSynValue::Option1(val));
        }
        ...
        fn init_actions1(&mut self) {
            ...
            self.stack.push(EnumSynValue::Actions1(val));
        }
        ...
        fn init_alt_items1(&mut self) {
            ...
            self.stack.push(EnumSynValue::AltItems1(val));
        }
