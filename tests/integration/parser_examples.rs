...
mod listener1 {
    ...
    use lexigram::{SymbolTable, grammar::{FactorId, ProdFactor, Symbol, VarId}, parser::{OpCode, Parser}};
...
mod listener2 {
    ...
    const SYMBOLS_NT: [&str; PARSER_NUM_NT] = ["E", "F", "E_1", "E_2", "E_3", "E_4", "E_5", "E_6"];
    const PARSING_FACTORS: [(VarId, &[Symbol]); 21] = [(0, &[Symbol::NT(7), Symbol::NT(2)]), (1, &[Symbol::T(5), Symbol::NT(0), Symbol::T(6)]), (1, &[Symbol::T(7)]), (1, &[Symbol::T(8)]), (2, &[Symbol::T(2), Symbol::NT(7), Symbol::NT(2)]), (2, &[Symbol::T(9), Symbol::NT(2)]), (2, &[Symbol::T(3), Symbol::NT(5), Symbol::NT(2)]), (2, &[Symbol::T(4), Symbol::NT(3), Symbol::NT(2)]), (2, &[Symbol::Empty]), (3, &[Symbol::NT(7), Symbol::NT(4)]), (4, &[Symbol::T(2), Symbol::NT(7), Symbol::NT(4)]), (4, &[Symbol::T(9), Symbol::NT(4)]), (4, &[Symbol::T(3), Symbol::NT(5), Symbol::NT(4)]), (4, &[Symbol::Empty]), (5, &[Symbol::NT(7), Symbol::NT(6)]), (6, &[Symbol::T(2), Symbol::NT(7), Symbol::NT(6)]), (6, &[Symbol::T(9), Symbol::NT(6)]), (6, &[Symbol::Empty]), (7, &[Symbol::T(1), Symbol::NT(3)]), (7, &[Symbol::T(0), Symbol::NT(7)]), (7, &[Symbol::NT(1)])];
    const PARSING_TABLE: [FactorId; 88] = [0, 0, 21, 21, 21, 0, 22, 0, 0, 21, 22, 21, 21, 22, 22, 22, 1, 22, 2, 3, 22, 22, 21, 21, 4, 6, 7, 21, 8, 21, 21, 5, 8, 9, 9, 22, 22, 22, 9, 22, 9, 9, 22, 22, 21, 21, 10, 12, 13, 21, 13, 21, 21, 11, 13, 14, 14, 22, 22, 22, 14, 22, 14, 14, 22, 22, 21, 21, 15, 17, 17, 21, 17, 21, 21, 16, 17, 19, 18, 22, 22, 22, 20, 22, 20, 20, 22, 22];
    const FLAGS: [u32; 8] = [1024, 0, 0, 0, 0, 0, 0, 0];
    const PARENT: [Option<VarId>; 8] = [None, None, Some(0), Some(0), Some(3), Some(0), Some(5), Some(0)];
    const OPCODES: [&[OpCode]; 21] = [&[OpCode::Exit(0), OpCode::NT(2), OpCode::NT(7)], &[OpCode::Exit(1), OpCode::T(6), OpCode::NT(0), OpCode::T(5)], &[OpCode::Exit(2), OpCode::T(7)], &[OpCode::Exit(3), OpCode::T(8)], &[OpCode::Loop(2), OpCode::Exit(4), OpCode::NT(7), OpCode::T(2)], &[OpCode::Loop(2), OpCode::Exit(5), OpCode::T(9)], &[OpCode::Loop(2), OpCode::Exit(6), OpCode::NT(5), OpCode::T(3)], &[OpCode::Loop(2), OpCode::Exit(7), OpCode::NT(3), OpCode::T(4)], &[OpCode::Exit(8)], &[OpCode::Exit(9), OpCode::NT(4), OpCode::NT(7)], &[OpCode::Loop(4), OpCode::Exit(10), OpCode::NT(7), OpCode::T(2)], &[OpCode::Loop(4), OpCode::Exit(11), OpCode::T(9)], &[OpCode::Loop(4), OpCode::Exit(12), OpCode::NT(5), OpCode::T(3)], &[OpCode::Exit(13)], &[OpCode::Exit(14), OpCode::NT(6), OpCode::NT(7)], &[OpCode::Loop(6), OpCode::Exit(15), OpCode::NT(7), OpCode::T(2)], &[OpCode::Loop(6), OpCode::Exit(16), OpCode::T(9)], &[OpCode::Exit(17)], &[OpCode::Exit(18), OpCode::NT(3), OpCode::T(1)], &[OpCode::Loop(7), OpCode::Exit(19), OpCode::T(0)], &[OpCode::Exit(20), OpCode::NT(1)]];
    const START_SYMBOL: VarId = 0;
...
pub(crate) mod listener14 {
    ...
    const SYMBOLS_NT: [&str; PARSER_NUM_NT] = ["E", "E_1", "E_2", "E_3", "E_4", "E_5", "E_6"];
    const PARSING_FACTORS: [(VarId, &[Symbol]); 14] = [(0, &[Symbol::NT(6), Symbol::NT(1)]), (1, &[Symbol::T(0), Symbol::NT(4), Symbol::NT(1)]), (1, &[Symbol::T(1), Symbol::NT(4), Symbol::NT(1)]), (1, &[Symbol::T(3), Symbol::NT(2), Symbol::NT(1)]), (1, &[Symbol::Empty]), (2, &[Symbol::NT(6), Symbol::NT(3)]), (3, &[Symbol::T(0), Symbol::NT(4), Symbol::NT(3)]), (3, &[Symbol::T(1), Symbol::NT(4), Symbol::NT(3)]), (3, &[Symbol::Empty]), (4, &[Symbol::NT(6), Symbol::NT(5)]), (5, &[Symbol::T(0), Symbol::NT(4), Symbol::NT(5)]), (5, &[Symbol::Empty]), (6, &[Symbol::T(2), Symbol::NT(2)]), (6, &[Symbol::T(4)])];
    const PARSING_TABLE: [FactorId; 42] = [14, 14, 0, 14, 0, 15, 1, 2, 14, 3, 14, 4, 15, 15, 5, 15, 5, 15, 6, 7, 14, 8, 14, 8, 15, 15, 9, 15, 9, 15, 10, 11, 14, 11, 14, 11, 15, 15, 12, 15, 13, 15];
    const FLAGS: [u32; 7] = [1024, 0, 0, 0, 0, 0, 0];
    const PARENT: [Option<VarId>; 7] = [None, Some(0), Some(0), Some(2), Some(0), Some(4), Some(0)];
    const OPCODES: [&[OpCode]; 14] = [&[OpCode::Exit(0), OpCode::NT(1), OpCode::NT(6)], &[OpCode::Loop(1), OpCode::Exit(1), OpCode::NT(4), OpCode::T(0)], &[OpCode::Loop(1), OpCode::Exit(2), OpCode::NT(4), OpCode::T(1)], &[OpCode::Loop(1), OpCode::Exit(3), OpCode::NT(2), OpCode::T(3)], &[OpCode::Exit(4)], &[OpCode::Exit(5), OpCode::NT(3), OpCode::NT(6)], &[OpCode::Loop(3), OpCode::Exit(6), OpCode::NT(4), OpCode::T(0)], &[OpCode::Loop(3), OpCode::Exit(7), OpCode::NT(4), OpCode::T(1)], &[OpCode::Exit(8)], &[OpCode::Exit(9), OpCode::NT(5), OpCode::NT(6)], &[OpCode::Loop(5), OpCode::Exit(10), OpCode::NT(4), OpCode::T(0)], &[OpCode::Exit(11)], &[OpCode::Exit(12), OpCode::NT(2), OpCode::T(2)], &[OpCode::Exit(13), OpCode::T(4)]];
    const START_SYMBOL: VarId = 0;
...
pub(crate) mod listener15 {
    ...
    const PARSER_NUM_T: usize = 8;
    const PARSER_NUM_NT: usize = 8;
    const SYMBOLS_T: [(&str, Option<&str>); PARSER_NUM_T] = [("EXP", Some("^")), ("MUL", Some("*")), ("NEG", Some("-")), ("ADD", Some("+")), ("ID", None), ("NUM", None), ("LPAREN", Some("(")), ("RPAREN", Some(")"))];
    const SYMBOLS_NT: [&str; PARSER_NUM_NT] = ["E", "F", "E_1", "E_2", "E_3", "E_4", "E_5", "E_6"];
    const PARSING_FACTORS: [(VarId, &[Symbol]); 17] = [(0, &[Symbol::NT(7), Symbol::NT(2)]), (1, &[Symbol::T(4)]), (1, &[Symbol::T(5)]), (1, &[Symbol::T(6), Symbol::NT(0), Symbol::T(7)]), (2, &[Symbol::T(0), Symbol::NT(5), Symbol::NT(2)]), (2, &[Symbol::T(1), Symbol::NT(3), Symbol::NT(2)]), (2, &[Symbol::T(3), Symbol::NT(3), Symbol::NT(2)]), (2, &[Symbol::Empty]), (3, &[Symbol::NT(7), Symbol::NT(4)]), (4, &[Symbol::T(0), Symbol::NT(5), Symbol::NT(4)]), (4, &[Symbol::T(1), Symbol::NT(3), Symbol::NT(4)]), (4, &[Symbol::Empty]), (5, &[Symbol::NT(7), Symbol::NT(6)]), (6, &[Symbol::T(0), Symbol::NT(5), Symbol::NT(6)]), (6, &[Symbol::Empty]), (7, &[Symbol::T(2), Symbol::NT(3)]), (7, &[Symbol::NT(1)])];
    const PARSING_TABLE: [FactorId; 72] = [17, 17, 0, 17, 0, 0, 0, 18, 18, 18, 18, 17, 18, 1, 2, 3, 18, 18, 4, 5, 17, 6, 17, 17, 17, 7, 7, 18, 18, 8, 18, 8, 8, 8, 18, 18, 9, 10, 17, 11, 17, 17, 17, 11, 11, 18, 18, 12, 18, 12, 12, 12, 18, 18, 13, 14, 17, 14, 17, 17, 17, 14, 14, 18, 18, 15, 18, 16, 16, 16, 18, 18];
    const FLAGS: [u32; 8] = [1024, 0, 0, 0, 0, 0, 0, 0];
    const PARENT: [Option<VarId>; 8] = [None, None, Some(0), Some(0), Some(3), Some(0), Some(5), Some(0)];
    const OPCODES: [&[OpCode]; 17] = [&[OpCode::Exit(0), OpCode::NT(2), OpCode::NT(7)], &[OpCode::Exit(1), OpCode::T(4)], &[OpCode::Exit(2), OpCode::T(5)], &[OpCode::Exit(3), OpCode::T(7), OpCode::NT(0), OpCode::T(6)], &[OpCode::Loop(2), OpCode::Exit(4), OpCode::NT(5), OpCode::T(0)], &[OpCode::Loop(2), OpCode::Exit(5), OpCode::NT(3), OpCode::T(1)], &[OpCode::Loop(2), OpCode::Exit(6), OpCode::NT(3), OpCode::T(3)], &[OpCode::Exit(7)], &[OpCode::Exit(8), OpCode::NT(4), OpCode::NT(7)], &[OpCode::Loop(4), OpCode::Exit(9), OpCode::NT(5), OpCode::T(0)], &[OpCode::Loop(4), OpCode::Exit(10), OpCode::NT(3), OpCode::T(1)], &[OpCode::Exit(11)], &[OpCode::Exit(12), OpCode::NT(6), OpCode::NT(7)], &[OpCode::Loop(6), OpCode::Exit(13), OpCode::NT(5), OpCode::T(0)], &[OpCode::Exit(14)], &[OpCode::Exit(15), OpCode::NT(3), OpCode::T(2)], &[OpCode::Exit(16), OpCode::NT(1)]];
    const START_SYMBOL: VarId = 0;
...
pub(crate) mod listener16 {
    ...
    const PARSER_NUM_T: usize = 3;
    const PARSER_NUM_NT: usize = 2;
    const SYMBOLS_T: [(&str, Option<&str>); PARSER_NUM_T] = [("ADD", Some("+")), ("SUB", Some("-")), ("ZERO", Some("0"))];
    const SYMBOLS_NT: [&str; PARSER_NUM_NT] = ["E", "E_1"];
    const PARSING_FACTORS: [(VarId, &[Symbol]); 4] = [(0, &[Symbol::T(1), Symbol::NT(0)]), (0, &[Symbol::T(2), Symbol::NT(1)]), (1, &[Symbol::T(0), Symbol::NT(1)]), (1, &[Symbol::Empty])];
