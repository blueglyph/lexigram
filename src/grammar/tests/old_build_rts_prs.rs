...
//! [RtsGen](crate::rtsgen::RtsGen), but it requires a lot of backend code to work correctly, so we keep a few rulesets
//! built more "locally" to detect early failures.
//!
