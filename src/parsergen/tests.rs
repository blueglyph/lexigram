        ...
        let tests: Vec<(
            ...
            */
            ...
            (RTS(100), 0, btreemap![
                ...
                11 => symbols![t 25],                   // 11: action -> mode ( Id )                 | ◄11 ) Id! ( mode              | Id
                12 => symbols![t 25],                   // 12: action -> push ( Id )                 | ◄12 ) Id! ( push              | Id
                13 => symbols![],                       // 13: action -> pop                         | ◄13 pop                       |
                14 => symbols![],                       // 14: action -> skip                        | ◄14 skip                      |
                15 => symbols![],                       // 15: action -> more                        | ◄15 more                      |
                16 => symbols![t 25],                   // 16: action -> type ( Id )                 | ◄16 ) Id! ( type              | Id
                17 => symbols![t 25],                   // 17: action -> channel ( Id )              | ◄17 ) Id! ( channel           | Id
                ...
                20 => symbols![nt 16],                  // 20: alt_item -> alt_item_1                | ◄20 ►alt_item_1               | alt_item_1
