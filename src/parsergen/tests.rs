        ...
        let tests: Vec<(
            ...
            */
            ...
            (RTS(100), 0, btreemap![
                ...
                5 => symbols![t 25],                    //  5: header -> lexicon Id ;                | ◄5 ; Id! lexicon              | Id
                6 => symbols![t 25],                    //  6: declaration -> mode Id ;              | ◄6 ; Id! mode                 | Id
                7 => symbols![t 25, nt 14],             //  7: option -> channels { Id option_1 }    | ◄7 } ►option_1 Id! { channels | Id option_1
                8 => symbols![t 25, nt 8],              //  8: rule -> fragment Id : match ;         | ◄8 ; ►match : Id! fragment    | Id match
                ...
                11 => symbols![t 25],                   // 11: action -> push ( Id )                 | ◄11 ) Id! ( push              | Id
                12 => symbols![],                       // 12: action -> pop                         | ◄12 pop                       |
                13 => symbols![],                       // 13: action -> skip                        | ◄13 skip                      |
                14 => symbols![],                       // 14: action -> mode                        | ◄14 mode                      |
                15 => symbols![t 25],                   // 15: action -> type ( Id )                 | ◄15 ) Id! ( type              | Id
                16 => symbols![t 25],                   // 16: action -> channel ( Id )              | ◄16 ) Id! ( channel           | Id
                17 => symbols![nt 9],                   // 17: match -> alt_items                    | ◄17 ►alt_items                | alt_items
                18 => symbols![nt 10],                  // 18: alt_items -> alt_item alt_items_1     | ►alt_items_1 ◄18 ►alt_item    | alt_item
                19 => symbols![nt 16],                  // 19: alt_item -> alt_item_1                | ◄19 ►alt_item_1               | alt_item_1
                20 => symbols![],                       // 20: repeat_item -> item repeat_item_2     | ►repeat_item_2 ►item          |
                21 => symbols![nt 9],                   // 21: item -> ( alt_items )                 | ◄21 ) ►alt_items (            | alt_items
                22 => symbols![nt 12],                  // 22: item -> ~ item                        | ◄22 ►item ~                   | item
                23 => symbols![],                       // 23: item -> EOF                           | ◄23 EOF                       |
            ...
            ], Default, btreemap![0 => vec![0, 1], 1 => vec![2, 3, 4], 2 => vec![5], 3 => vec![6], 4 => vec![7], 5 => vec![8, 40, 41], 6 => vec![10], 7 => vec![11, 12, 13, 14, 15, 16], 8 => vec![17], 9 => vec![18], 10 => vec![19], 11 => vec![42, 43], 12 => vec![21, 22, 23, 24, 26, 27, 44, 45]]),
            /*
