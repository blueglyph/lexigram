...
mod lexer_source1 {
    ...
    use crate::dfa::{StateId, TermType, Terminal, TokenId};
    ...
    const TERMINAL_TABLE: [Terminal;5] = [
        Terminal { typ: TermType::None, channel: 0, push_mode: None, push_state: None, pop: false },
        Terminal { typ: TermType::Token(0), channel: 0, push_mode: None, push_state: None, pop: false },
        Terminal { typ: TermType::None, channel: 0, push_mode: Some(1), push_state: Some(2), pop: false },
        Terminal { typ: TermType::None, channel: 0, push_mode: None, push_state: None, pop: false },
        Terminal { typ: TermType::None, channel: 0, push_mode: None, push_state: None, pop: true }];
