...
pub mod typedef_type_parser {
    ...
    static OPCODES: [&[OpCode]; 18] = [&[OpCode::Exit(0), OpCode::NT(1)], &[OpCode::Loop(1), OpCode::Exit(1), OpCode::NT(2)], &[OpCode::Exit(2)], &[OpCode::Exit(3), OpCode::NT(3)], &[OpCode::Exit(4), OpCode::NT(4)], &[OpCode::Exit(5), OpCode::T(1), OpCode::NT(6), OpCode::T(8), OpCode::T(9)], &[OpCode::Exit(6), OpCode::T(1), OpCode::T(8), OpCode::T(9), OpCode::T(5)], &[OpCode::Exit(7), OpCode::T(1), OpCode::NT(5), OpCode::T(2), OpCode::T(8)], &[OpCode::Exit(8), OpCode::T(1), OpCode::NT(5), OpCode::T(6)], &[OpCode::NT(7), OpCode::Exit(9), OpCode::NT(8)], &[OpCode::Loop(6), OpCode::Exit(10), OpCode::T(8), OpCode::T(0)], &[OpCode::Exit(11)], &[OpCode::Loop(7), OpCode::Exit(12), OpCode::NT(8), OpCode::T(4)], &[OpCode::Loop(7), OpCode::Exit(13), OpCode::NT(8), OpCode::T(3)], &[OpCode::Exit(14)], &[OpCode::Exit(15), OpCode::NT(8), OpCode::T(3)], &[OpCode::Exit(16), OpCode::T(8)], &[OpCode::Exit(17), OpCode::T(7)]];
