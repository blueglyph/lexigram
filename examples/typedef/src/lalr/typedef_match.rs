...
pub mod typedef_match_lexer {
    ...
    const NBR_STATES: LexStateId = 14;
    ...
    static STATE_TABLE: [LexStateId; 183] = [
...
pub mod typedef_match_parser {
    ...
    static ACTION: [LRAction; 341] = [
        LRE,LRE,LRE,LRE,LRE,LRE,LRR(2),LRR(2),LRR(2),LRR(2),LRR(2),LRE,LRE,LRE,LRE,LRE,LRE,LRS(9),LRS(10),LRS(2),LRS(3),LRR(0),LRE,LRE,LRE,LRS(5),LRE,LRS(15),LRS(16),LRE,LRE,LRE,LRE,LRE,LRE,
        LRE,LRE,LRE,LRE,LRS(18),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRS(5),LRE,LRS(15),LRS(16),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRS(5),LRE,LRS(15),LRS(16),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRS(5),
        LRE,LRS(15),LRS(16),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRS(5),LRE,LRS(15),LRS(16),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRA,LRE,LRE,LRS(4),LRE,LRE,LRE,
        LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRS(14),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRR(1),LRR(1),LRR(1),LRR(1),LRR(1),LRE,LRE,LRE,LRE,LRE,LRE,LRR(3),LRR(3),
        LRR(3),LRR(3),LRR(3),LRE,LRE,LRE,LRE,LRE,LRE,LRR(4),LRR(4),LRR(4),LRR(4),LRR(4),LRE,LRE,LRE,LRE,LRE,LRE,LRS(21),LRE,LRE,LRE,LRE,LRE,LRR(15),LRE,LRR(15),LRR(15),LRE,LRE,LRE,LRE,LRE,
        LRE,LRE,LRR(14),LRE,LRR(14),LRR(14),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRS(23),LRE,LRS(6),LRS(7),LRE,LRE,LRE,LRE,LRE,LRE,LRR(8),LRR(8),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRS(24),
        LRS(25),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRS(26),LRE,LRS(6),LRS(7),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRS(27),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRR(11),LRE,
        LRR(11),LRR(11),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRR(10),LRR(10),LRR(10),LRR(10),LRR(10),LRE,LRE,LRE,LRE,LRE,LRE,LRS(30),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,
        LRE,LRR(5),LRR(5),LRR(5),LRR(5),LRR(5),LRE,LRE,LRE,LRE,LRE,LRE,LRR(9),LRR(9),LRR(9),LRR(9),LRR(9),LRE,LRE,LRE,LRE,LRE,LRE,LRR(6),LRR(6),LRR(6),LRR(6),LRR(6),LRE,LRR(13),LRE,LRR(13),LRR(13),LRE,LRE,
        LRE,LRE,LRE,LRE,LRE,LRR(12),LRE,LRR(12),LRR(12),LRE,LRE,LRE,LRE,LRE,LRE,LRR(7),LRR(7),LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE,LRE];
    static GOTO: [LRStateId; 56] = [
        8,1,0,0,0,0,0,0,0,11,12,0,13,0,0,0,0,0,0,0,17,0,0,0,0,19,0,0,0,0,0,0,0,0,20,0,0,0,0,0,
        0,22,0,0,0,0,0,0,28,0,0,0,0,0,0,29];
    ...
    static STATE_SYMBOL: [Symbol; 31] = [
        Symbol::Empty,Symbol::NT(1),Symbol::T(8),Symbol::T(9),Symbol::T(2),Symbol::T(3),Symbol::T(3),Symbol::T(4),Symbol::NT(0),Symbol::T(6),Symbol::T(7),Symbol::NT(2),Symbol::NT(3),Symbol::NT(5),Symbol::T(9),Symbol::T(5),Symbol::T(6),Symbol::NT(6),Symbol::T(6),Symbol::NT(4),Symbol::NT(6),Symbol::T(6),Symbol::NT(6),Symbol::T(1),Symbol::T(0),
        Symbol::T(1),Symbol::T(1),Symbol::T(1),Symbol::NT(6),Symbol::NT(6),Symbol::T(6)];
    ...
    #[derive(Debug)]
    pub enum EnumSynValue { Program(SynProgram), Stmt(SynStmt), Decl(SynDecl), IdI(SynIdI), Inst(SynInst), Expr(SynExpr) }
