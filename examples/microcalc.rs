...
mod microcalc_parser {
    ...
    pub enum CtxFunArgs {
        /// `fun_args -> [expr ,]* expr`
        FunArgs1 { star: SynFunArgs1, expr: SynExpr },
        /// `fun_args -> ε`
        FunArgs2,
    }
