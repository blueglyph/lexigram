...
pub mod pandemonium_parser {
    ...
    #[derive(Debug)]
    enum SynValue { Star1(SynStar1), Plus1(SynPlus1), StarA1(SynStarA1), PlusA1(SynPlusA1), SepList1(SynSepList1), SepListOpt1(SynSepListOpt1) }
            ...
            match call {
                Call::Enter => {
                    ...
                    match nt {
                        ...
                        22 => self.listener.init_l_rrec_i(),        // l_rrec_i
