    ...
    impl EnumSynValue {
        ...
        fn nt(&self) -> VarId {
            match &self {
                ...
                EnumSynValue::LRrec(_) => 11,
                EnumSynValue::Lrec(_) => 12,
                EnumSynValue::Amb(_) => 13,
                EnumSynValue::StarA(_) => 14,
                EnumSynValue::PlusA(_) => 15,
                EnumSynValue::LStarA(_) => 16,
                EnumSynValue::LStarAI(_) => 17,
                EnumSynValue::LPlusA(_) => 18,
                EnumSynValue::LPlusAI(_) => 19,
                EnumSynValue::SepList(_) => 20,
                EnumSynValue::SepListOpt(_) => 21,
                EnumSynValue::LSepList(_) => 22,
                EnumSynValue::LSepListI(_) => 23,
                EnumSynValue::LSepListOpt(_) => 24,
                EnumSynValue::LSepListOptI(_) => 25,
                EnumSynValue::RrecI(_) => 26,
                EnumSynValue::LRrecI(_) => 27,
                EnumSynValue::LrecI(_) => 28,
                EnumSynValue::AmbI(_) => 29,
                EnumSynValue::NvExample(_) => 30,
                EnumSynValue::NvStar(_) => 31,
                EnumSynValue::NvPlus(_) => 32,
                EnumSynValue::NvLStar(_) => 33,
                EnumSynValue::NvLStarI(_) => 34,
                EnumSynValue::NvLPlus(_) => 35,
                EnumSynValue::NvLPlusI(_) => 36,
                EnumSynValue::NvRrec(_) => 37,
                EnumSynValue::NvLRrec(_) => 38,
                EnumSynValue::NvLrec(_) => 39,
                EnumSynValue::NvStarA(_) => 40,
                EnumSynValue::NvPlusA(_) => 41,
                EnumSynValue::NvLStarA(_) => 42,
                EnumSynValue::NvLStarAI(_) => 43,
                EnumSynValue::NvLPlusA(_) => 44,
                EnumSynValue::NvLPlusAI(_) => 45,
                EnumSynValue::NvSepList(_) => 46,
                EnumSynValue::NvSepListOpt(_) => 47,
                EnumSynValue::NvLSepList(_) => 48,
                EnumSynValue::NvLSepListI(_) => 49,
                EnumSynValue::NvLSepListOpt(_) => 50,
                EnumSynValue::NvLSepListOptI(_) => 51,
                EnumSynValue::NvRrecI(_) => 52,
                EnumSynValue::NvLRrecI(_) => 53,
                EnumSynValue::NvLrecI(_) => 54,
